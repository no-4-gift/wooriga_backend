...
import com.webapp.wooriga.mybatis.challenge.service.ChallengeServiceImpl;
...
public class ChallengeController {
    ...
    @ApiOperation(value = "챌린지 신청", notes = "챌린지 신청(response : 200 - 성공 409 - 전송 데이터 중 존재하지 않는 데이터를 포함하고 있어 db에 저장되지 않음 411 - 조건에 맞지 않음")
    ...
    @ApiOperation(value = "챌린지 인증 등록(request : 등록된 챌린지 번호,날짜,인증 사진)", notes = "챌린지 인증 등록(response : 200 - 성공," +
